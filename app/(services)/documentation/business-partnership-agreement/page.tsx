  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-orange-50/30 to-slate-100">
      ...
      <section className="relative flex items-center justify-center text-center min-h-[50vh] md:min-h-[65vh] overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-48 h-48 sm:w-96 sm:h-96 bg-yellow-500/20 rounded-full blur-3xl animate-pulse delay-1000" />
        ...
        >
          ...
          >
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-orange-500 to-yellow-500 rounded-xl blur-md opacity-50" />
              <div className="relative bg-gradient-to-br from-orange-500 to-yellow-500 p-3 rounded-xl sm:p-4">
                <Users
          ...
          <p className="mt-3 text-xs sm:text-sm text-yellow-300 px-2">
            Lawizer offers drafting services tailored to your business,
            providing clarity on financial contributions and preventing
            conflicts.
          </p>
        </motion.div>
      </section>
          ...
          >
            ...
            <div className="bg-white rounded-xl sm:rounded-3xl p-6 sm:p-8 shadow-xl shadow-slate-200/50 border border-slate-100">
              <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-4 flex items-center gap-3">
                <div className="w-1 h-6 sm:h-8 bg-gradient-to-b from-orange-500 to-yellow-500 rounded-full" />
              ...
              <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-6 sm:mb-8">
                A clear, formal agreement is the most effective tool to prevent
                major disputes and legal challenges in a partnership. It ensures
                that every partner's contribution and expected return are
                clearly documented.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-6 sm:mb-8">
                {benefits.map((b, i) => (
                  <motion.div
                    ...
                    className="flex items-start gap-3 p-3 rounded-lg sm:rounded-xl bg-gradient-to-br from-slate-50 to-orange-50/50 border border-slate-100 hover:shadow-md transition-shadow"
                  >
              ...
              <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-4">
                To draft an agreement that accurately reflects the partnership,
                the following crucial details are needed:
              </p>
          ...
          >
            ...
            <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-xl sm:rounded-3xl p-6 sm:p-8 shadow-2xl border border-slate-700">
              ...
              <p className="text-slate-300 text-xs sm:text-sm mb-5 sm:mb-6 leading-relaxed">
                Legally define the investment, roles, and profit-sharing
                structure to ensure a stable and legally enforceable business
                relationship.
              </p>

              {/* Buttons - slightly smaller padding and text size */}
              <button
                className={`w-full group relative overflow-hidden px-5 py-3 sm:px-6 sm:py-4 rounded-xl font-semibold ${primaryBg} text-white shadow-lg shadow-yellow-500/30 hover:shadow-xl hover:shadow-yellow-500/40 transition-all duration-300 mb-3`}
              >
