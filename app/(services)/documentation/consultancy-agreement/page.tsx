          ...
          >
            ...
            <div className="bg-white rounded-xl sm:rounded-3xl p-6 sm:p-8 shadow-xl shadow-slate-200/50 border border-slate-100">
              ...
              <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-6 sm:mb-8">
                A formal contract prevents scope creep and payment disputes by
                setting clear, enforceable terms for the consultancy engagement.
                It also establishes legal protection for both the company and
                the consultant.
              </p>
