      ...
      <section className="relative flex items-center justify-center text-center min-h-[65vh] overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4 tracking-tight text-white">
            Joint Venture (JV) Agreement Drafting
          </h1>
          ...
          >
            <div className="bg-white rounded-3xl p-8 shadow-xl shadow-slate-200/50 border border-slate-100">
              <h2 className="text-2xl font-bold text-slate-900 mb-4 flex items-center gap-3">
                ...
                Why a Formal Joint Venture Agreement is Essential
              </h2>
              ...
              <p className="text-slate-700 leading-relaxed mb-4">
                To accurately define the terms of the joint venture, the
          ...
          >
            <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-8 shadow-2xl border border-slate-700">
              <h3 className="text-xl font-bold text-white mb-3">
                Launch Your Venture Securely
              </h3>
              <p className="text-slate-300 text-sm mb-6 leading-relaxed">
                Ensure your joint venture's investment, management, and
                profit-sharing are legally protected and clearly defined.
              </p>
