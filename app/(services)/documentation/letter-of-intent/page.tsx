...
import {
  FileText, // Icon for Document/Intent
  ArrowRight,
  CheckCircle2,
  Shield,
  Scale,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-cyan-50/30 to-slate-100">
      <section className="relative flex items-center justify-center text-center min-h-[50vh] md:min-h-[65vh] overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        ...
        <div className="absolute top-1/4 left-1/4 w-48 h-48 sm:w-96 sm:h-96 bg-cyan-500/20 rounded-full blur-3xl animate-pulse" />
        ...
        >
          ...
          >
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-cyan-500 to-blue-500 p-3 rounded-xl sm:p-4">
                <FileText
          ...
          <p className="text-sm md:text-lg text-slate-300 max-w-2xl mx-auto leading-relaxed px-2">
            ...
            business transaction, establishing initial terms and understanding.
          </p>
          ...
          >
            ...
            <div className="bg-white rounded-xl sm:rounded-3xl p-6 sm:p-8 shadow-xl shadow-slate-200/50 border border-slate-100">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-6 sm:mb-8">
                {benefits.map((b, i) => (
                  <motion.div
                    ...
                    className="flex items-start gap-3 p-3 rounded-lg sm:rounded-xl bg-gradient-to-br from-slate-50 to-cyan-50/50 border border-slate-100 hover:shadow-md transition-shadow"
                  >
              ...
              <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-4">
                To draft the LOI, the following key transaction details are
                required:
              </p>
          ...
          >
            ...
            <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-xl sm:rounded-3xl p-6 sm:p-8 shadow-2xl border border-slate-700">
              <h3 className="text-lg sm:text-xl font-bold text-white mb-2">
                Establish Preliminary Intent
              </h3>
              <p className="text-slate-300 text-xs sm:text-sm mb-5 sm:mb-6 leading-relaxed">
                Start negotiations on solid ground by formally outlining the
                core terms of the business transaction with a clear Letter of
                Intent.
              </p>
          ...
          <div className="space-y-3">
            {faqs.map((f, i) => (
              <motion.div
                ...
                className="border border-slate-200 rounded-lg sm:rounded-xl overflow-hidden hover:border-cyan-300 transition-colors"
              >
                <button
                  onClick={() => setOpenFaq(openFaq === i ? -1 : i)}
                  className="w-full flex items-center justify-between p-4 sm:p-5 text-left bg-gradient-to-r from-slate-50 to-transparent hover:from-cyan-50 transition-colors"
                >
