...
function HeroWithAddons() {
 ...
 <section
 ref={heroRef}
 className="relative flex flex-col items-center justify-center text-center overflow-hidden bg-gradient-to-br from-[#1c0f0a] via-[#92400e] to-[#451a03] text-white px-4 sm:px-6 pt-[100px] pb-[56px]"
 >
 {/* Glow Orbs */}
