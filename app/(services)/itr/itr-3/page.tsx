  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-orange-50/30 to-slate-100">
      ...
      <section className="relative flex items-center justify-center text-center min-h-[50vh] md:min-h-[65vh] overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        ...
        <div className="absolute top-1/4 left-1/4 w-48 h-48 sm:w-96 sm:h-96 bg-orange-500/20 rounded-full blur-3xl animate-pulse" />
        ...
        >
          ...
          >
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-orange-500 to-red-500 rounded-xl blur-md opacity-50" />
              <div className="relative bg-gradient-to-br from-orange-500 to-red-500 p-3 rounded-xl sm:p-4">
                <TrendingUp
          ...
          <p className="text-sm md:text-lg text-slate-300 max-w-2xl mx-auto leading-relaxed px-2">
            **The Entrepreneur's Form:** Mandatory for Individuals and HUFs
            having income from **Proprietary Business or Profession**.
          </p>
          <p className="mt-3 text-xs sm:text-sm text-red-300 px-2">
            Our CAs handle complex business income, financial statements, and
            audit requirements to ensure accurate and compliant ITR-3 filing.
          </p>
        </motion.div>
      </section>
              ...
              <div className="space-y-2 mb-6 sm:mb-8">
                <div className="flex items-start gap-3 p-3 rounded-lg bg-red-50/50 border border-red-100 transition-colors">
                  ...
                  <p className="text-slate-700 text-sm">
                    ITR-3 requires mandatory disclosure of the **Balance Sheet,
                    Profit & Loss Account**, and often a **Tax Audit Report**,
                    making professional CA assistance vital for compliance.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-3">
            {faqs.map((f, i) => (
              <motion.div
                ...
                className="border border-slate-200 rounded-lg sm:rounded-xl overflow-hidden hover:border-orange-300 transition-colors"
              >
                <button
