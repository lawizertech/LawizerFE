  ...
  howItsDone: [
    {
      ...
      desc: "Buy the plan and securely upload your Form 16 and Form 26AS to our vault within 24 hours.",
    },
    {
      step: 2,
      title: "Expert Review",
      desc: "Our CA reviews your documents, computes your tax liability, and prepares your return.",
    },
    {
      step: 3,
      title: "Filing & Acknowledgement",
      desc: "Your ITR is filed on the Income Tax portal and you receive an official acknowledgement.",
    },
  ],
  documentsRequired: [
  ...
  faqs: [
    {
      ...
      a: "The due date for salaried individuals is typically 31st July of the assessment year. Late filing can attract penalties.",
    },
    {
      q: "Can I file ITR without Form 16?",
      a: "Yes, though Form 16 simplifies the process. Salary slips and bank statements can serve as alternatives.",
    },
    {
      q: "What happens after I buy the plan?",
      a: "Our team reaches out within a few hours. You'll be guided to upload documents securely. Filing is completed within the estimated days.",
    },
    {
      q: "Is my data safe?",
      a: "Absolutely. We use bank-level encryption to protect all your documents and personal information.",
    },
  ],
};
