...
const PLAN: PlanConfig = {
  ...
  howItsDone: [
    {
      ...
      desc: "You're assigned a senior CA partner. A detailed kickoff call maps out your full tax profile.",
    },
    {
      step: 2,
      title: "Filing & Strategy",
      desc: "Your CA handles the filing, computations, and all required schedules. A tax strategy document is shared.",
    },
    {
      step: 3,
      title: "Year-round Advisory",
      desc: "Monthly 1:1 advisory calls continue all year — advance tax, investments, compliance reminders and more.",
    },
  ],
  documentsRequired: [
  ...
  faqs: [
    {
      q: "What does 'year-round advisory' mean?",
      a: "Monthly 1:1 calls with your CA, quarterly advance tax reminders, and on-demand support for any tax query throughout the year.",
    },
    {
      q: "Is representation before the IT Department included?",
      a: "Yes. If you receive a scrutiny notice or tax demand, your CA represents you before the department at no extra cost.",
    },
    {
      q: "Can this plan cover my family members too?",
      a: "By default it covers one PAN. For family coverage please contact our team — bundled pricing is available.",
    },
    {
      q: "Is there a client portal?",
      a: "Yes. Diamond members get exclusive access to a real-time dashboard to track filing status, documents, and advisory reports.",
    },
  ],
};
