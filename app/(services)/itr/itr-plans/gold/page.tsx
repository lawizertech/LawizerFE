...
const PLAN: PlanConfig = {
  ...
  howItsDone: [
    {
      ...
      desc: "A brief intake call to understand your income profile and map out the filing session.",
    },
    {
      step: 2,
      title: "Live Filing Session",
      desc: "Video call with a senior CA to file all income sources accurately, including NRI and business income.",
    },
    {
      step: 3,
      title: "Tax Planning Report",
      desc: "Receive a written tax planning report with strategies to reduce your tax outgo next year.",
    },
  ],
  documentsRequired: [
  ...
  faqs: [
    {
      q: "What does the tax planning report include?",
      a: "It covers 80C investment suggestions, HRA optimisation, NPS contributions, advance tax schedules, and personalised deduction strategies.",
    },
    {
      q: "Is NRI filing covered?",
      a: "Yes. This plan covers NRI filing including DTAA benefits, foreign asset disclosure in Schedule FA, and global income reporting.",
    },
    {
      q: "Can I file for multiple years under this plan?",
      a: "This plan covers one assessment year. For multiple years, please contact our team for a custom quote.",
    },
    {
      q: "How is this different from Silver?",
      a: "Gold adds a dedicated tax planning session, ESOP/NRI coverage, and business income support that Silver does not include.",
    },
  ],
};
