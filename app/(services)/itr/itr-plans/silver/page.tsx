  ...
  howItsDone: [
    {
      ...
      desc: "Buy the plan and schedule your video call with a senior CA at a time that suits you.",
    },
    {
      step: 2,
      title: "Live Video Session",
      desc: "Join the video call. Your CA reviews documents with you live and prepares the return in real time.",
    },
    {
      step: 3,
      title: "Review & File",
      desc: "You review the computation sheet, approve it, and the return is filed with acknowledgement sent immediately.",
    },
  ],
  documentsRequired: [
  ...
  faqs: [
    {
      ...
      a: "Typically 45–90 minutes depending on your income complexity. Additional calls can be scheduled if needed.",
    },
    {
      q: "What platforms are used for the video call?",
      a: "We use Google Meet or Zoom. A link is shared on your registered email after scheduling.",
    },
    {
      q: "Can I file crypto and FnO income under this plan?",
      a: "Yes. This plan fully covers capital gains from crypto, FnO, intraday trading, and more.",
    },
