...
function HeroWithAddons() {
  ...
  return (
    <section
      ref={heroRef}
      className="relative flex flex-col items-center justify-center text-center overflow-hidden bg-gradient-to-br from-[#1c0f0a] via-[#7c2d12] to-[#3f1a07] text-white px-4 sm:px-6"
      ...
      <div className="relative z-10 w-full max-w-3xl flex flex-col items-center">
        ...
        >
          ...
          <p className="text-slate-400 text-xs sm:text-sm mb-8 tracking-wide">
            Expert Drafting · Buyer & Seller Protection · State Law Compliance
          </p>
