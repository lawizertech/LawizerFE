  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50/30 to-slate-100">
      ...
      <section className="relative flex items-center justify-center text-center min-h-[65vh] overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        ...
        <div className="absolute top-1/4 left-1/4 w-72 sm:w-96 h-72 sm:h-96 bg-purple-500/20 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-1/4 right-1/4 w-72 sm:w-96 h-72 sm:h-96 bg-indigo-500/20 rounded-full blur-3xl animate-pulse delay-1000" />
        ...
        >
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed">
            Legally define the terms for your{" "}
            <strong>office, shop, or warehouse</strong> lease with a document
            tailored to protect your business interests and minimize future
            disputes.
          </p>
          <p className="mt-2 sm:mt-3 text-xs sm:text-sm md:text-base text-purple-300">
      ...
      <div className="max-w-6xl mx-auto px-6 py-12 sm:py-16">
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          ...
          >
            <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-xl shadow-slate-200/50 border border-slate-100">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-slate-900 mb-4 flex items-center gap-3">
              ...
              <p className="text-sm sm:text-base md:text-lg text-slate-700 leading-relaxed mb-8">
              ...
              <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-slate-900 mb-5 flex items-center gap-2">
              ...
              <div className="grid sm:grid-cols-2 gap-4 mb-8">
                {benefits.map((b, i) => (
                  <motion.div
                    ...
                    className="flex items-start gap-3 p-3 sm:p-4 rounded-xl bg-gradient-to-br from-slate-50 to-purple-50/50 border border-slate-100 hover:shadow-md transition-shadow"
                  >
                    ...
                    <p className="text-xs sm:text-sm md:text-base text-slate-700 font-medium leading-snug pt-1">
                      {b.text}
                    </p>
                  </motion.div>
                ))}
              ...
              <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-slate-900 mb-4 flex items-center gap-2">
              ...
              <div className="space-y-2 mb-8">
                {prerequisites.map((p, i) => (
                  ...
                  >
                    <CheckCircle2
                      className="w-4 sm:w-5 h-4 sm:h-5 text-green-600 flex-shrink-0 mt-0.5"
                      strokeWidth={2}
                    />
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                {deliverables.map((d, i) => (
                  <div
                    key={i}
                    className="flex items-center gap-3 p-2 sm:p-3 rounded-lg bg-red-50/50 border border-red-100"
                  >
          ...
          >
            <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl border border-slate-700">
              ...
              <div className="mt-6 pt-6 border-t border-slate-700 text-xs sm:text-sm">
        ...
        <motion.section
          ...
          className="bg-white rounded-3xl p-4 sm:p-8 shadow-xl shadow-slate-200/50 border border-slate-100"
        >
          <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-slate-900 mb-6 flex items-center gap-3">
            ...
            {faqs.map((f, i) => (
              ...
              >
                <button
                  ...
                  className="w-full flex items-center justify-between p-3 sm:p-5 text-left bg-gradient-to-r from-slate-50 to-transparent hover:from-purple-50 transition-colors text-sm sm:text-base"
                >
                  <span className="font-semibold text-slate-900 pr-2 sm:pr-4">
                    {f.q}
                  </span>
                  <ChevronDown
                    className={`w-4 sm:w-5 h-4 sm:h-5 text-slate-600 flex-shrink-0 transition-transform duration-300 ${
                ...
                >
                  <p className="px-3 sm:px-5 pb-3 sm:pb-5 text-slate-700 leading-relaxed text-xs sm:text-sm md:text-base">
                    {f.a}
                  </p>
                </div>
              </motion.div>
