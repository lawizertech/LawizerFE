...
function HeroWithAddons() {
 ...
 <section
 ref={heroRef}
 className="relative flex flex-col items-center justify-center text-center overflow-hidden bg-gradient-to-br from-[#0f172a] via-[#065f46] to-[#052e16] text-white px-4 sm:px-6 pt-[100px] pb-[56px]"
 >
 {/* Glow Orbs */}
