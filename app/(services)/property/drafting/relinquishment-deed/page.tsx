...
import {
  Users, // Icon for Co-owners/Family
  ArrowRight,
  CheckCircle2,
  Shield,
  FileText,
          ...
          >
            <div className="bg-white rounded-3xl p-8 shadow-xl shadow-slate-200/50 border border-slate-100">
              ...
              <p className="text-slate-700 leading-relaxed mb-4">
                To prepare your legally sound Relinquishment Deed, please gather the
          ...
          >
            <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-8 shadow-2xl border border-slate-700">
              ...
              <p className="text-slate-300 text-sm mb-6 leading-relaxed">
                Legally document the voluntary transfer of a co-owner's share to
                ensure future clarity and prevent disputes.
              </p>
              ...
              <div className="mt-6 pt-6 border-t border-slate-700">
                <div className="flex items-center gap-3 text-slate-300 text-sm mb-2">
                  ...
                  <span>Compliant with Local Property Laws</span>
                </div>
                <div className="flex items-center gap-3 text-slate-300 text-sm mb-2">
                  <CheckCircle2 className="w-4 h-4 text-green-400" />
                  <span>Minimizes Future Family Disputes</span>
                </div>
