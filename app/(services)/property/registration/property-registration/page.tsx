...
function HeroWithAddons() {
 ...
 <section
 ref={heroRef}
 className="relative flex flex-col items-center justify-center text-center overflow-hidden bg-gradient-to-br from-[#1f0f0f] via-[#7c2d12] to-[#431407] text-white px-4 sm:px-6 pt-[100px] pb-[56px]"
 >
 {/* Glow Orbs */}
