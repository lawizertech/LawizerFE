...
export async function generateMetadata({
  ...
  const description =
    pageData.subtitle ||
    `${pageData.title} — expert legal service by Lawizer. Fast, affordable, handled by verified professionals.`;
  const url = `${BASE_URL}/startup-businesslegal/protectbusiness/${slug}`;
...
export default async function Page({
  ...
  const serviceSchema = buildLegalServiceSchema({
    ...
    url: `${BASE_URL}/startup-businesslegal/protectbusiness/${slug}`,
