...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    closing:
      "Lawizer reserves the right to conduct periodic re-verification and may suspend your profile pending re-verification.",
  },
  {
    id: "a3",
  ...
  },
  {
    ...
    paragraphs: [
      "Lawizer may suspend or permanently remove your profile from the Platform, with or without prior notice, in cases of:",
    ],
    listItems: [
    ...
    <div className="bg-white scroll-smooth">
      ...
      <section className="px-5 pt-28 md:pt-32 pb-16 md:pb-20 border-b border-gray-200">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold mb-4 text-[#0D1F3C]">Attorney Terms & Conditions</h1>
