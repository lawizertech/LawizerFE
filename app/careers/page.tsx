...
const internalJobs: Job[] = [
  ...
  },
  {
    ...
    type: "Full-time",
    description:
      "Own outreach to startup founders, SME owners, and CA/CS firms. Experience in SaaS or professional-services B2B sales preferred.",
    skills: [
  ...
  },
  {
    ...
    description:
      "Write high-quality, SEO-optimised legal guides, FAQs, and news articles. Background in law or journalism is a strong advantage.",
    skills: [
  ...
  },
  {
    ...
    description:
      "Research case law, regulatory updates, and compliance topics. Open to penultimate and final-year LLB students.",
    skills: [
...
const hiringSteps: HiringStep[] = [
  ...
  },
  {
    ...
    title: "Intro Call",
    description:
      "A 20-minute call with our team to understand your experience and answer your questions about Lawizer.",
  },
  {
    emoji: "✍️",
    title: "Short Task",
  ...
  },
  {
    ...
    description:
      "Meet the founder and team lead. We keep it conversational — we want to understand you, not trip you up.",
  },
];
    ...
    >
      ...
      <div className="flex flex-col flex-1 p-5">
        ...
        <div className="flex items-center gap-2 mb-3">
          <span
            className={`text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full border ${tagClass(job.tag)}`}
          >
            {job.tag}
          </span>
        ...
        {/* Description */}
        <p className="text-[#6b7280] text-xs leading-relaxed flex-1 mb-4 line-clamp-3">{job.description}</p>
...
export default function CareersPage() {
  return (
    <div className="scroll-smooth bg-white">
      {/* ── HERO ─────────────────────────────────────────────────────────── */}
      <section className="min-h-screen flex flex-col justify-center items-center px-4 py-16 text-center relative overflow-hidden bg-[#06101e]">
        {/* Gradient layers */}
        ...
        <div className="max-w-3xl mx-auto z-10 relative">
          ...
          >
            Join a team building India&apos;s most trusted legal platform for founders — and make legal help simple,
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
            {stats.map((stat, idx) => (
              <div key={idx} className="text-center">
                <div className="text-4xl sm:text-5xl font-bold mb-3 text-brand-red">{stat.number}</div>
                <div className="text-sm sm:text-base font-medium text-gray-500">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="internship" className="py-20 sm:py-28 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <h2 className="text-4xl sm:text-5xl font-bold mb-4 text-gray-900">Internship at Lawizer</h2>
            <div className="w-20 h-1 mb-6 divider-accent rounded-full" />
            <p className="text-lg max-w-2xl leading-relaxed mb-10 text-gray-500">
              We&apos;re India&apos;s fastest growing LegalTech platform — looking for driven, curious, and enthusiastic
              individuals across legal, tech, and business roles. Fully remote, 1-month programme with real
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/60 text-xs">
                    Fill in the form — we review all applications within 5 business days.
                  </p>
                </div>
              </div>
              <a
      ...
      <section id="startup-jobs" className="py-14 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            className="mb-8"
          >
            <h2 className="text-3xl sm:text-4xl font-bold mb-2 text-gray-900">Legal &amp; Startup Jobs</h2>
          ...
          <div className="flex items-center gap-2 text-xs text-[#9ca3af]">
            ...
            <span>Jobs updated every 48 hours. Listings sourced from public job boards.</span>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 sm:py-28 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="mb-16">
            <h2 className="text-4xl sm:text-5xl font-bold mb-4 text-gray-900">Why Work at Lawizer?</h2>
            <div className="w-20 h-1 mb-8 divider-accent rounded-full" />
            <p className="text-lg max-w-3xl leading-relaxed text-gray-500">
              We&apos;re not just another legal-services startup. We&apos;re a team of builders, lawyers, and
              problem-solvers who believe that legal protection shouldn&apos;t be a privilege.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {perks.map((perk, idx) => (
              <div
                key={idx}
                className="transition-all duration-300 border border-gray-200 bg-white hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(202,45,66,0.12)] hover:border-brand-red p-8 rounded-2xl"
              >
      ...
      <section className="py-20 sm:py-28 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl sm:text-5xl font-bold mb-4 text-gray-900">Hear From Our Interns</h2>
          <div className="w-20 h-1 mb-8 divider-accent rounded-full" />
          <p className="text-lg mb-16 max-w-3xl leading-relaxed text-gray-500">
            Every year we bring on talented students from law schools and business programs. Here&apos;s what they say
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {testimonials.map((testimonial, idx) => (
              <div
                key={idx}
                className="border-l-[3px] border-brand-red transition-all duration-300 bg-white hover:shadow-[0_8px_24px_rgba(202,45,66,0.1)] hover:-translate-y-0.5 p-8 rounded-2xl"
              >
      ...
      <section className="py-20 sm:py-28 px-4 bg-white" id="open-roles">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl sm:text-5xl font-bold mb-4 text-gray-900">Open Roles at Lawizer</h2>
          <div className="w-20 h-1 mb-12 divider-accent rounded-full" />
          <div className="space-y-6">
            {internalJobs.map((job, idx) => (
              <div
                key={idx}
                className="border border-gray-200 transition-all duration-300 bg-white hover:shadow-[0_16px_32px_rgba(202,45,66,0.1)] hover:border-brand-red flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 p-8 rounded-2xl"
              >
      ...
      <section className="py-20 sm:py-28 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl sm:text-5xl font-bold mb-4 text-gray-900">Our Hiring Process</h2>
          <div className="w-20 h-1 mb-16 divider-accent rounded-full" />
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {hiringSteps.map((step, idx) => (
              <div
                key={idx}
                className="transition-all duration-300 bg-white border border-gray-200 hover:-translate-y-1.5 hover:shadow-[0_12px_28px_rgba(202,45,66,0.12)] hover:border-brand-red p-8 rounded-2xl"
              >
