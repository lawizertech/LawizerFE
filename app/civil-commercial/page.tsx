...
import {
  Scale, // Main Icon for Civil/Justice
  Gavel, // Icon for Court/Litigators
  ArrowRight,
  Briefcase, // Icon for Commercial
  Lock, // Icon for Criminal
} from "lucide-react";
...
export default function CivilCriminalLegalPage() {
  ...
  // Define color theme
  const primaryColor = "#6d28d9"; // Deep Purple
  const primaryAccent = "#a78bfa"; // Light Indigo
  const secondaryColor = "#0e172b"; // Dark Blue/Slate

  // --- Content from PDF (Citations removed) ---
  const civilContent = {
    ...
    contactTitle: "Contact our Civil & Commercial Law Team",
    contactInstructions:
      ...
      >
        ...
        >
          ...
          <p className="text-lg text-gray-200 max-w-xl mx-auto">
            Comprehensive legal representation for litigation across Civil, Commercial, and Criminal jurisdictions.
          </p>
