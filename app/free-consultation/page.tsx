...
export default function FreeConsultationPage() {
  ...
  return (
    <>
      ...
      <div className="min-h-[100dvh] pt-[80px] bg-[var(--bg-soft)] flex items-center justify-center px-4 pb-12 font-[family-name:var(--font-body)]">
        <div className="w-full max-w-[520px]">
          ...
          >
            ...
            <h1 className="font-[family-name:var(--font-head)] text-[clamp(28px,5vw,40px)] font-extrabold text-[var(--text-primary)] leading-tight tracking-tight mb-3">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-5">
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 border-[1.5px] border-[var(--border)] rounded-[var(--radius-md)] text-sm font-[family-name:var(--font-body)] text-[var(--text-primary)] bg-[var(--bg-soft)] outline-none transition-colors duration-200 focus:border-[var(--brand)]"
                />
              </div>
              ...
              <div className="mb-7">
                ...
                <textarea
                  ...
                  required
                  rows={4}
                  className="w-full px-4 py-3 border-[1.5px] border-[var(--border)] rounded-[var(--radius-md)] text-sm font-[family-name:var(--font-body)] text-[var(--text-primary)] bg-[var(--bg-soft)] outline-none resize-y min-h-[110px] transition-colors duration-200 leading-relaxed focus:border-[var(--brand)]"
                />
              </div>

              {/* Error */}
              {error && (
                <p className="text-[var(--brand)] text-[13px] mb-4 font-medium">
                  ⚠ {error}
                </p>
              )}
        ...
        {success && (
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
            ...
            >
              ...
              <h2 className="font-[family-name:var(--font-head)] text-[22px] font-extrabold text-[var(--text-primary)] mb-3 leading-tight">
                Request Received! 🎉
              </h2>
