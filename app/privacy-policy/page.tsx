...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    listItems: [
      {
        bold: '"User", "You", "Your"',
        text: " refers to any individual or entity accessing or using the Platform who is competent to enter into binding contracts under the Indian Contract Act, 1872.",
      },
      {
        bold: '"Personal Data"',
        text: " means any information that can identify you directly or indirectly, such as your name, email address, phone number, or government-issued identification numbers.",
      },
      {
        bold: '"Sensitive Personal Data (SPD)"',
        text: " means information as defined under the Information Technology (Reasonable Security Practices and Procedures and Sensitive Personal Data or Information) Rules, 2011, including passwords, financial information, health data, and biometric data.",
      },
      {
        bold: '"Services"',
        text: " refers to all legal, compliance, documentation, and advisory services provided through the Platform.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    listItems: [
      {
        bold: "Verified Attorneys and CS/CA Professionals:",
        text: " To provide services you have engaged us for, subject to professional confidentiality obligations.",
      },
      {
        bold: "Government Authorities:",
        text: " As required for filings with MCA, IP India, GSTN, Income Tax Department, and similar bodies.",
      },
      { bold: "Payment Processors:", text: " Razorpay and PhonePe, subject to their respective privacy policies." },
      {
        bold: "Technology Partners:",
        text: " Cloud hosting providers, CRM systems, and communication tools, all bound by data processing agreements.",
      },
      {
        bold: "Legal Obligations:",
        text: " When disclosure is required by law, court order, or government authority.",
      },
    ],
  },
  {
    ...
    listItems: [
      { bold: "Essential Cookies:", text: " Required for the Platform to function (login sessions, security tokens)." },
      {
        ...
        text: " Google Analytics and similar tools to understand usage patterns (anonymised).",
      },
      {
        bold: "Marketing Cookies:",
        text: " To serve relevant advertisements on third-party platforms, with your consent.",
      },
    ],
    closing:
  ...
  },
  {
    ...
    listItems: [
      {
        bold: "Account and KYC data:",
        text: " Retained for the duration of the engagement and up to 5 years post-termination, as required under Indian law.",
      },
      {
        bold: "Financial records and invoices:",
        text: " Retained for 8 years in compliance with the Income Tax Act, 1961 and GST laws.",
      },
      { bold: "Communication records:", text: " Retained for 3 years." },
    ],
    closing:
      "Upon your verified request for deletion, we will anonymise or delete data that we are not legally required to retain.",
  },
  {
    id: "pp8",
    title: "8. Your Rights",
    paragraphs: [
      "Under applicable Indian data protection laws and the Digital Personal Data Protection Act, 2023 (DPDPA), you have the right to:",
    ],
    listItems: [
    ...
    closing:
      'To exercise any of these rights, write to us at admin@lawizer.com with the subject line "Data Rights Request". We will respond within 30 days.',
  },
  {
    id: "pp9",
    title: "9. Security",
  ...
  },
  {
    ...
    closing:
      "This policy is governed by the laws of India. Any disputes arising shall be subject to the exclusive jurisdiction of the courts at Kolkata, West Bengal.",
  },
];
    ...
    <div className="bg-white scroll-smooth">
      ...
      <section className="px-5 pt-28 md:pt-32 pb-16 md:pb-20 border-b border-gray-200">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold mb-4 text-[#0D1F3C]">Privacy Policy</h1>
      ...
      <div className="px-5 py-8 md:py-12">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="p-6 md:p-8 rounded-xl mb-16 bg-gray-50 border border-gray-200">
            <p className="text-xs font-bold uppercase mb-6 text-gray-500 tracking-wider">Table of Contents</p>
          ...
          {SECTIONS.map((section) => (
            <section key={section.id} id={section.id} className="mb-16 scroll-mt-28">
              ...
              {section.subsections &&
                section.subsections.map((subsection, idx) => (
                  <div key={idx} className="mt-6">
                    ...
                    {subsection.closing && (
                      <p className="text-sm md:text-base mt-3 text-gray-700">{subsection.closing}</p>
                    )}
                  </div>
                ))}
              ...
              {/* Closing paragraph */}
              {section.closing && <p className="text-sm md:text-base mt-3 text-gray-700">{section.closing}</p>}
            </section>
          ))}
        </div>
      </div>
