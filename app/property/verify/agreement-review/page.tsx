...
import {
  FileText, // Main icon for Agreement/Contract Review
  ArrowRight,
  CheckCircle2,
  Shield,
  Scale, // Used for legal validity
  ChevronDown,
  Clock, // For process timeline/efficiency
} from "lucide-react";
...
export default function SaleAgreementReviewPage() {
  ...
  const processSteps = [
    "You can upload your document(s) after the payment is complete and choose your convenient time to discuss it.",
    "All the heavy lifting of reading, interpreting and understanding shall be done by the senior lawyers for you.",
    "At the scheduled time, Lawizer’s system will auto-generate calls to connect you with the expert lawyer who will be ready with the document review for you.",
  ];

  const faqs = [
    {
      q: "What is the purpose of reviewing the Agreement to Sale?",
      a: "Reviewing the Agreement to Sale is crucial because these documents outline the terms and conditions of the transaction—including price, payment schedule, possession date, and responsibilities—protecting your interests and preventing disputes.",
    },
    {
      q: "What does Lawizer ensure during the review?",
      a: "Lawizer ensures your agreements are clear, legally valid, and enforceable under Indian property laws.",
    },
    {
      q: "Who conducts the document review?",
      a: "All the heavy lifting of reading, interpreting, and understanding the document shall be done by senior lawyers for you.",
    },
    {
      q: "How does the consultation work?",
      a: "You upload your documents and choose a convenient time. At the scheduled time, Lawizer's system will auto-generate calls to connect you with the expert lawyer who will be ready with the document review for you.",
    },
    {
      q: "Does this service cover properties in different locations?",
      a: "Yes. For instance, if you’re buying a flat in New Town, Kolkata or selling land near Rajarhat or Howrah outskirts, Lawizer provides the expert review needed.",
    },
  ];
      ...
      <section className="relative flex items-center justify-center text-center min-h-[65vh] overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        ...
        >
          ...
          <p className="text-base md:text-lg text-slate-300 max-w-2xl mx-auto leading-relaxed">
            ...
            Agreement is **legally sound, valid, and enforceable**, protecting
            your interests before final property transfer.
          </p>
          <p className="mt-3 text-sm text-orange-300">
            Lawizer ensures your agreement is clear, legally valid, and enforceable under Indian property laws.
          </p>
        </motion.div>
      </section>
          ...
          >
            <div className="bg-white rounded-3xl p-8 shadow-xl shadow-slate-200/50 border border-slate-100">
              ...
              <p className="text-slate-700 leading-relaxed mb-8">
                Whether you're buying or selling a property, having a legally sound
                Agreement to Sale or Sale Agreement is crucial as it outlines all
          ...
          >
            <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-8 shadow-2xl border border-slate-700">
              ...
              <p className="text-slate-300 text-sm mb-6 leading-relaxed">
                Let a senior lawyer handle the heavy lifting of reading,
                interpreting, and understanding your agreement documents for you
               .
              </p>
