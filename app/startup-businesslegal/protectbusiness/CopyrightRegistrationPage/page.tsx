  ...
  const faqs = [
    {
      ...
      a: "No, but it is highly recommended for enforcement.",
    },
    {
      q: "What works can be registered?",
      a: "Literary, musical, artistic, films, software, photography, etc.",
    },
    {
      q: "How long does it take?",
      a: "Generally, 2–9 months if there are no major objections.",
    },
    {
      q: "Who can apply?",
      a: "Author, owner, or anyone with an interest in the work.",
    },
  ];
      ...
      <section className="relative flex items-center justify-center text-center min-h-[65vh] overflow-hidden bg-gradient-to-br from-[#0e172b] via-[#121f3c] to-[#0e172b]">
        ...
        >
          ...
          >
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-[#c92c41] to-[#e99b2b] p-4 rounded-2xl">
                <Copyright className="w-16 h-16 text-white" strokeWidth={1.5} />
              </div>
            </div>
          </motion.div>
          ...
          <p className="text-base md:text-lg text-slate-300 max-w-2xl mx-auto leading-relaxed">
            Legally establish ownership of your original works and gain proof
            for enforcement against infringement.
          </p>
        </motion.div>
      </section>
          ...
          >
            <div className="bg-white rounded-3xl p-8 shadow-xl shadow-slate-200/50 border border-slate-100">
              ...
              <p className="text-slate-700 leading-relaxed mb-8">
                ...
                content, art, music, films, software, and more. While copyright
                exists automatically upon creation, registration provides
                official proof and makes enforcement easier in case of
