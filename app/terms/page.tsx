...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    listItems: [
      {
        bold: '"Platform"',
        text: " means the website www.lawizer.com, its subdomains, mobile applications, and any digital interface operated by Lawizer.",
      },
      {
        bold: '"Services"',
        text: " means all legal, compliance, documentation, ITR filing, and advisory services offered through the Platform.",
      },
      {
        bold: '"User"',
        text: " means any individual, startup, SME, or entity accessing the Platform who is competent to enter into contracts under the Indian Contract Act, 1872.",
      },
      {
        bold: '"Attorney"',
        text: " means an independent, verified legal professional listed on the Platform to provide legal consultation.",
      },
      {
        bold: '"Content"',
        text: " means all text, guides, articles, videos, templates, and materials available on the Platform.",
      },
    ],
  },
  {
    ...
    closing:
      "Lawizer acts as a facilitator connecting users with qualified professionals. Lawizer itself does not provide legal advice unless explicitly stated. The Platform is not a law firm.",
  },
  {
    id: "t4",
    ...
    closing:
      "You acknowledge that delays or errors arising from incorrect information provided by you will be your sole responsibility and Lawizer shall not be liable for any resultant penalties, rejections, or losses.",
  },
  {
    id: "t5",
  ...
  },
  {
    ...
    listItems: [
      {
        bold: "Before Work Commences:",
        text: " 100% refund of Lawizer's professional fees (excluding payment gateway charges), provided the request is made within 24 hours of payment.",
      },
      {
        bold: "After Work Has Commenced:",
        text: " A partial refund may be granted at Lawizer's discretion based on work completed. Government fees already paid are non-refundable.",
      },
      { bold: "Consultation Fees:", text: " Non-refundable once a consultation session has been initiated." },
      {
        bold: "Service Failures:",
        text: " Where Lawizer is unable to deliver a service due to reasons within our control, a full refund will be issued within 7–10 working days.",
      },
    ],
    closing:
      "Refund requests must be submitted to admin@lawizer.com with your order details. Approved refunds will be credited to your original payment method within 48–72 working hours of approval.",
  },
  {
    id: "t7",
    ...
    <div className="bg-white scroll-smooth">
      ...
      <section className="px-5 pt-28 md:pt-32 pb-16 md:pb-20 border-b border-gray-200">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold mb-4 text-[#0D1F3C]">Terms of Service</h1>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          {SECTIONS.map((section) => (
            <section key={section.id} id={section.id} className="mb-16 scroll-mt-28">
              <h2 className="border-l-4 border-brand-red text-[#1a1a2e] font-bold pl-3 mt-8 mb-3 text-2xl">
                {section.title}
              </h2>
