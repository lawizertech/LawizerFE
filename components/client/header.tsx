...
const SignInModal = dynamic(() => import("../auth/signinPopup").then((mod) => mod.SignInModal), { ssr: false });
const SignupModal = dynamic(() => import("../auth/signupPopup").then((mod) => mod.SignupModal), { ssr: false });
const CompleteProfileModal = dynamic(() => import("../auth/CompleteProfileModal"), { ssr: false });
const ForgotPasswordModal = dynamic(() => import("../auth/forgotPasswordModal").then((mod) => mod.ForgotPasswordModal), { ssr: false });
const ProfessionalModal = dynamic(() => import("../auth/ProfessionalModal").then((mod) => mod.ProfessionalModal), { ssr: false });
