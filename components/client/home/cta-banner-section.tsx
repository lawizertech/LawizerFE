...
export function CTABannerSection() {
  return (
    <div className="cta-banner flex flex-col md:flex-row items-center justify-between gap-6 px-6 py-10 md:px-12 md:py-16 text-center md:text-left w-full max-w-7xl mx-auto rounded-3xl" style={{ margin: "0 auto 80px",  width: "calc(100% - 32px)", }}>
