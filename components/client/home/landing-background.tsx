...
export function LandingBackground() {
  return (
    <div className="absolute inset-0 w-full h-full pointer-events-none overflow-hidden z-0">
      ...
      <div className="absolute top-[60%] left-[-10%] w-[600px] h-[600px] bg-blue-500/10 rounded-full blur-[150px]" />
      <div className="absolute bottom-[-10%] right-[10%] w-[700px] h-[700px] bg-brand-red/5 rounded-full blur-[150px]" />
      ...
      <div className="lg:hidden absolute top-[700px] right-[-40px] w-[180px] h-[180px] bg-blue-500/10 rounded-full blur-[50px] pointer-events-none" />
