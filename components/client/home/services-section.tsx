...
export default function ServicesSection() {
 ...
 <span className={`font-[family-name:var(--,'Syne',sans-serif)] text-[22px] font-extrabold leading-[1.15] mb-2 transition-colors duration-220 ${on ? p.tw.text : 'text-[#0D0F14]'}`}>
 {p.label}
 </span>
...
function SvcRow({ svc, phase }: { svc:Svc; phase:Phase }) {
 ...
 <span className={`text-sm font-extrabold leading-[1.2] transition-colors duration-150 ${hov ? phase.tw.text : 'text-[#0D0F14]'}`}>
 {svc.price}
 </span>
 </span>
