...
function TestiCard({ t, colorClass }: { t: (typeof testimonials)[0]; colorClass: string }) {
  return (
    <div
      className="testi-card p-6 min-w-[280px] max-w-[340px] flex-[0_0_300px] flex flex-col gap-0"
    >
      <div className="testi-stars mb-3">★★★★★</div>
      <p
        className="testi-text text-[13px] leading-7 mb-4 flex-1"
      >
        "{t.text}"
      </p>
      <div className="testi-author mb-3">
        <div className={`testi-avatar ${colorClass} text-xs w-9 h-9`}>
          {t.initials}
        </div>
        <div>
...
export function TestimonialsSection() {
  ...
  return (
    <section
      id="testimonials"
      className="testimonials-section py-20 overflow-hidden"
    >
      <div className="max-w-7xl mx-auto px-[5%]">
        ...
        >
          ...
          >
            what{" "}
            <span className="text-brand-red">clients</span>{" "}
            say
          </h2>
          ...
          <div className="flex justify-center">
            <div
              className="google-rating inline-flex flex-wrap items-center justify-center gap-4 py-3.5 px-6"
            >
              ...
              <div className="rating-stars">
                {[...Array(5)].map((_, i) => <span key={i} className="star text-lg">★</span>)}
              </div>
              <div>
                <span className="font-[family-name:var(--font-head)] text-[22px] font-extrabold text-gray-900">
                  4.5
                </span>
