...
export function WhatsAppButton() {
  return (
    ...
    >
      <div className="w-10 h-10 md:w-12 md:h-12 rounded-full transition-all duration-300 group-hover:scale-110 group-hover:shadow-[0_0_20px_6px_rgba(37,211,102,0.5)]">
