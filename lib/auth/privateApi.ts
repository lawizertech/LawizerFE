...
// ─── Next.js same-origin API instance ─────────────────────────────────────────
// Used for calls to /api/* routes on the same Next.js origin.
// Also injects the access token so server-side route handlers can validate it.
