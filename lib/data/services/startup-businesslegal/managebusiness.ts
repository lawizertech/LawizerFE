...
export const servicesData: Record<string, ServiceData> = {
    ...
    faqs: [
      {
        ...
        answer:
          "A) Documents required from Director: Resignation Letter, DIR-11 acknowledgment, PAN Card, Residence Proof, DIN declarations. B) Documents required from Company: Board Resolution accepting the resignation. Lawizer will assist in preparing and filing all documents with the ROC.",
      },
      {
  ...
  IncreasingCapitalOfCompanyPage: {
    ...
    subtitle: "Legally expand your company's share capital to enable fundraising, attract new investors, and support business growth.",
    ...
    sections: [
      ...
      },
      {
        ...
        data: [
          ...
          "Drafted Shareholders' Resolution",
    ...
    sections: [
      ...
      },
      {
        ...
        data: [
          ...
          "Drafted Indemnity Bond and Affidavit documents",
          "Board Resolution and Director's Consent",
        ],
      },
    ],
    addons: [
